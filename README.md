...
![Build Status](https://github.com/LogicInGeneral2/devops-capstone-project/actions/workflows/ci-build.yaml/badge.svg)

This project is for the devops capstone project, by IBM.
